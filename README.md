...
4. [Approach taken](README.md#approach-taken)
5. [Build diary](README.md#build-diary)
6. [Displays](README.md#displays)
7. [Key learning & Future improvements](README.md#key-learning--future-improvements)
